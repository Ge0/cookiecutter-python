...
INSTALL_REQUIRES = [{% if cookiecutter.project_cli == "click" %}"click"{% endif %}]
...
{%- if cookiecutter.project_cli != "none" %}
    entry_points={"console_scripts": ["{{ cookiecutter.project_prog }}={{ cookiecutter.project_package }}.__main__:main"]},
{%- endif %}
